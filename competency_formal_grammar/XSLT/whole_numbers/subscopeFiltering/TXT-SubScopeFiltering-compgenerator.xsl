...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="$subProcessParam">
                                                        <xsl:for-each select="$subProcessParam">
                                                            <xsl:variable name="subProcessInsert" as="xs:string" select="current()"/>
                                                            <xsl:sequence
                                                                select="concat($currLevel1, ' ', $currLevel2, ' ', $currLevel3, ' ', $currLevel4, ' ', $scopeInsert, ' ', $subscopeInsert, ' ', $subProcessInsert, '&#10;')"
                                                            />
                                                        </xsl:for-each>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <xsl:sequence
                                                            select="concat($currLevel1, ' ', $currLevel2, ' ', $currLevel3, ' ', $currLevel4, ' ', $scopeInsert, ' ', $subscopeInsert, '&#10;')"
                                                />
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:for-each>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$subProcessParam">
                                                    <xsl:for-each select="$subProcessParam">
                                                        <xsl:variable name="subProcessInsert" as="xs:string" select="current()"/>
                                                        <xsl:sequence
                                                            select="concat($currLevel1, ' ', $currLevel2, ' ', $currLevel3, ' ', $scopeInsert, ' ', $subscopeInsert, ' ', $subProcessInsert, '&#10;')"
                                                        />
                                                    </xsl:for-each>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:sequence
                                                        select="concat($currLevel1, ' ', $currLevel2, ' ', $currLevel3, ' ', $scopeInsert, ' ', $subscopeInsert, '&#10;')"
                                            />
                                                </xsl:otherwise>
                                            </xsl:choose>
                                        </xsl:for-each>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$subProcessParam">
                                        <xsl:for-each select="$subProcessParam">
                                            <xsl:variable name="subProcessInsert" as="xs:string" select="current()"/>
                                            <xsl:sequence
                                                select="concat($currLevel1, ' ', $currLevel2, ' ', $scopeInsert, ' ', $subscopeInsert, ' ', $subProcessInsert, '&#10;')"
                                            />
                                        </xsl:for-each>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:sequence
                                            select="concat($currLevel1, ' ', $currLevel2, ' ', $scopeInsert, ' ', $subscopeInsert, '&#10;')"
                                />
                                    </xsl:otherwise>
                                </xsl:choose>
                            </xsl:for-each>
    ...
    <xsl:template match="/">
        ...
        <!--****************WITH NOTATIONS************************************************
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="text/formalProcess/fp-Pp-n.txt">
        ...
        <!--
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="text/formalProcess/fp-mathop-n.txt">
            <xsl:variable name="FP_notation" as="element()+">
                <xsl:for-each select="key('notationKey', $notation)">
                    <xsl:sequence select=".[parent::* ! name() = $formal_process]"/>
                </xsl:for-each>
        ...
        <!--****************WITHOUT NOTATIONS************************************************
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="text/formalProcess/fp-Pp.txt">
        ...
        <!--
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="text/formalProcess/fp-mathop.txt">
            <xsl:variable name="FP_noNot" as="element()+">
                <xsl:for-each select="key('notationKey', $noNot)">
                    <xsl:sequence select=".[parent::* ! name() = $formal_process]"/>
                </xsl:for-each>
        ...
        <!-- ################################################
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="text/knowledgeProcess/kp-Pp.txt">
        ...
        <!--  <xsl:comment>####################################</xsl:comment>
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="text/knowledgeProcess/kp-mathop.txt">
            <xsl:variable name="KP" as="element()+">
                <xsl:for-each select="key('scopes', $wholenum)">
                    <xsl:sequence select=".[parent::* ! name() = $knowledge_process]"/>
                </xsl:for-each>
        ...
        <xsl:result-document method="text" href="text/knowledgeProcess/kp-Pp-sp.txt">
            <xsl:variable name="KP" as="element()+">
                <xsl:for-each select="key('scopes', $wholenum)">
                    <xsl:sequence select=".[parent::* ! name() = $knowledge_process]"/>
                </xsl:for-each>
        ...
        <!--  <xsl:comment>####################################</xsl:comment>
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="text/knowledgeProcess/kp-mathop-sp.txt">
            <xsl:variable name="KP" as="element()+">
                <xsl:for-each select="key('scopes', $wholenum)">
                    <xsl:sequence select=".[parent::* ! name() = $knowledge_process]"/>
                </xsl:for-each>
