...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- SCOPE PARAMs, called upon by the scope key^ to output only the chunks that have
        an @class that matches the given param -->
    ...
    <!-- 1st and 2nd-level PARENT competency writer. This template function does not include scope strings or subscope strings, 
    ...
    <!-- this template match on the entire document "/" is where the string components of sentences are filtered through and 
            captured, then sent up to the sentence writers as input params to be structured.
