...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <!-- THIS XSLT PRODUCES MULTIPLE XML FILES SEPARATED BY SCOPE -->
    ...
    <xsl:template name="sentenceWriter" as="element()+">
        ...
        <!-- purpose of the params: 
                TAKE THE NODES, CONVERT THEM TO STRINGS FOR SENTENCE CONSTRUCTION (if they match the key filter)-->

        <!-- Purpose of the variables:
            TAKE THE NODES, CONVERT THEM TO STRINGS TO USE AS ELEMENT NAMES
            -->
...
-->
        ...
        <xsl:result-document method="xml" indent="yes" href="K5scopes/integers/integersNestedOutput-TP.xml">
            <xml>
                <xsl:comment>****************************************************</xsl:comment>
        ...
        <xsl:result-document method="xml" indent="yes" href="K5scopes/rational_nums/rationalNestedOutput-TP.xml">
            <xml>
                <xsl:comment>********************************************************</xsl:comment>
        ...
        <xsl:result-document method="xml" indent="yes" href="K5scopes/algebra_exp/algebraExpNestedOutput-TP.xml">
            <xml>
                <xsl:comment>**************************************************************</xsl:comment>
        ...
        <xsl:result-document method="xml" indent="yes" href="K5scopes/numeric_exp/numericExpNestedOutput-TP.xml">
            <xml>
                <xsl:comment>*************************************************************************</xsl:comment>
