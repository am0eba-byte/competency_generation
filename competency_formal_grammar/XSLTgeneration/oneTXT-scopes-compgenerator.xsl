   ...
   <!-- SCOPE PARAMS -->
    ...
    <xsl:template match="/">
     <!--******************* COMPLEX NUMBERS SCOPE *********************************************** -->
        <xsl:result-document method="text" href="complex_nums/text/complexNumsSeedOutput.txt">
    ...
    <!--**************** IMAGINARY NUMBERS SCOPE *********************************************-->
        <xsl:result-document method="text" href="imaginary_nums/text/imaginaryNumsSeedOutput.txt">
        <!-- <xsl:comment>####################################</xsl:comment>
            <xsl:comment>Formal Process Branch </xsl:comment>
            <xsl:comment>####################################</xsl:comment>-->
        <!-- <xsl:comment>####################################</xsl:comment>
...
<!--**************** INTEGERS SCOPE *********************************************-->
        <xsl:result-document method="text" href="integers/text/integersSeedOutput.txt">
        <!-- <xsl:comment>####################################</xsl:comment>
            <xsl:comment>Formal Process Branch </xsl:comment>
            <xsl:comment>####################################</xsl:comment>-->
        <!--<xsl:comment>####################################</xsl:comment>
...
<!--**************** RATIONAL NUMBERS SCOPE *********************************************-->
        ...
        <xsl:result-document method="text" href="plane/text/planeSeedOutput.txt">
            <!-- <xsl:comment>####################################</xsl:comment>
            <xsl:comment>Formal Process Branch </xsl:comment>
            <xsl:comment>####################################</xsl:comment>
            -->
