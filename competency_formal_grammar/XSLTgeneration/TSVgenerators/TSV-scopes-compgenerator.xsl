...
<!--**************** RATIONAL NUMBERS SCOPE *********************************************-->
        ...
        <!-- NOTE: change "involving Plane" scope string attachment to "in Plane"? -->
        ...
        <!--
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="plane/TSV/fp-Pp.tsv">
        ...
        <!--
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="plane/TSV/fp-mathop.tsv">
            <xsl:variable name="FP_plane" as="element()+">
                <xsl:for-each select="key('scopes', $plane)">
                    <xsl:sequence select=".[parent::* ! name() = $formal_process]"/>
                </xsl:for-each>
        ...
        <!-- <xsl:comment>####################################</xsl:comment>
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="plane/TSV/kp-Pp.tsv">
        ...
        <!--  <xsl:comment>####################################</xsl:comment>
            ...
            <xsl:comment>####################################</xsl:comment>-->
        <xsl:result-document method="text" href="plane/TSV/kp-mathop.tsv">
            <xsl:variable name="KP_plane" as="element()+">
                <xsl:for-each select="key('scopes', $plane)">
                    <xsl:sequence select=".[parent::* ! name() = $knowledge_process]"/>
                </xsl:for-each>
